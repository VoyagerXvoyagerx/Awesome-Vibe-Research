...
| nature-skills | 符合 nature 论文学术表达和科研绘图的 Skill | skill | <!--stars:Yuan1z0825/nature-skills-->⭐&nbsp;43.3k<!--/stars--> | [GitHub](https://github.com/Yuan1z0825/nature-skills) · [魔搭 Skills](https://modelscope.cn/collections/stn54999/nature-skills) | - | - |
...
| autoresearch | Andrej Karpathy 的自主 ML 研究代理，在单 GPU 上自动运行实验并改进模型 | agent | <!--stars:karpathy/autoresearch-->⭐&nbsp;96.4k<!--/stars--> | [GitHub](https://github.com/karpathy/autoresearch) | - | - |
...
| 项目名称 | 描述 | 类型 | Stars | 链接 | Demo | Paper |
|---|---|---|---|---|---|---|
| Academic Research Skills | 覆盖学术写作、润色、投稿检查和发表流程的 Claude Code skill 套件，也覆盖文献调研 | skill | <!--stars:Imbad0202/academic-research-skills-->⭐&nbsp;48.8k<!--/stars--> | [GitHub](https://github.com/Imbad0202/academic-research-skills) | - | - |
