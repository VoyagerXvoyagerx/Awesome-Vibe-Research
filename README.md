...
| nature-skills | 符合 nature 论文学术表达和科研绘图的 Skill | skill | <!--stars:Yuan1z0825/nature-skills-->⭐&nbsp;41.3k<!--/stars--> | [GitHub](https://github.com/Yuan1z0825/nature-skills) · [魔搭 Skills](https://modelscope.cn/collections/stn54999/nature-skills) | - | - |
...
| autoresearch | Andrej Karpathy 的自主 ML 研究代理，在单 GPU 上自动运行实验并改进模型 | agent | <!--stars:karpathy/autoresearch-->⭐&nbsp;95.7k<!--/stars--> | [GitHub](https://github.com/karpathy/autoresearch) | - | - |
...
| Aether | 基于 OpenCode 的开源项目，面向科研人员提供 web 与桌面端统一的 AI 研究工作环境 | agent/应用 | <!--stars:Science-Discovery/Aether-->⭐&nbsp;73<!--/stars--> | [GitHub](https://github.com/Science-Discovery/Aether) | - | - |
...
| 项目名称 | 描述 | 类型 | Stars | 链接 | Demo | Paper |
|---|---|---|---|---|---|---|
| Academic Research Skills | 覆盖学术写作、润色、投稿检查和发表流程的 Claude Code skill 套件，也覆盖文献调研 | skill | <!--stars:Imbad0202/academic-research-skills-->⭐&nbsp;47.9k<!--/stars--> | [GitHub](https://github.com/Imbad0202/academic-research-skills) | - | - |
